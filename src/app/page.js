...
export default function Home() {
  return (
    <>
      <main className="__className_5f7ae9">
        ...
        <section className="section bg-accentPrimary">
          <div className="m-auto max-w-screen-2xl overflow-hidden px-6 md:px-10 lg:px-14">
            <h1 className="font-bold leading-heading m-0 p-0 w-auto tracking-tight md:tracking-tighter top-32 z-1 pt-12 leading-small text-center text-[50px] text-textInverseHighlight md:relative md:top-[72px] lg:top-32 md:p-0 md:text-4xl lg:text-[118px]">
              Mortgages
              <br />
              made simple
            </h1>
